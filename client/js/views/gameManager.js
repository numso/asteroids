...
define([
  ...
  return Backbone.View.extend({
    ...
    startGame: function (e) {
      ...
      var option = parseInt(e.target.className.split(' ')[1], 10);
    ...
    bindSound: function () {
      this.sound = new Howl({ urls: ['./snd/tron.mp3'], loop: true, volume: 0.1 });
    ...
    saveHS: function () {
      ...
      var name = $('.name').val();
      var score = parseInt($('.newHS').html(), 10);
      hsManager.save(name, score);
      this.scores = hsManager.get();
      $.post('/saveScores', { scores: this.scores }, function () { location.reload(true); });
    },
